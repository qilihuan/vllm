...
from transformers.configuration_utils import ALLOWED_ATTENTION_LAYER_TYPES, ALLOWED_MLP_LAYER_TYPES
...
def is_rope_parameters_nested(rope_parameters: dict[str, Any]) -> bool:
    ...
    if not rope_parameters:
        return False
    return set(rope_parameters.keys()).issubset(set(ALLOWED_ATTENTION_LAYER_TYPES) | set(ALLOWED_MLP_LAYER_TYPES))
