...
from vllm.models.deepseek_v4.amd.model_ops.utils import get_and_maybe_dequant_weights
...
if is_rocm_aiter_fp4bmm_enabled():
    ...
    from vllm.models.deepseek_v4.amd.model_ops.utils import quark_post_load_weights
...
class MLAAttention(nn.Module):
    ...
    def _forward_prefill_cached_chunked(
        ...
        """
        from vllm.models.deepseek_v4.amd.model_ops.attentions.triton_merge_attn_states import merge_attn_states
    ...
    def forward_impl(
        ...
        if forward_context.context.is_dummy_run:
            ...
            output_shape[-1] = dsv4_config.hf_config.hidden_size
            output_dtype = dsv4_config.torch_dtype
