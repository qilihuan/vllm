...
from vllm.models.deepseek_v4.amd.config import QuantizationConfig
...
class RMSNorm(nn.Module):
    def __init__(
        ...
        self.dim = dim
        self.eps = eps
        self.weight = dsv4_parameter(torch.ones(dim))
...
class RMSNormGated(nn.Module):
    ...
    def __init__(
        ...
        super().__init__()
        self.eps = eps
        self.weight = dsv4_parameter(torch.empty(hidden_size))
...
class GemmaRMSNorm(nn.Module):
    ...
    def __init__(
        ...
        super().__init__()
        self.weight = dsv4_parameter(torch.zeros(hidden_size))
...
class LayerNorm(nn.Module):
    def __init__(
        ...
        self.eps = eps
        self.weight = dsv4_parameter(torch.ones(dim))
        self.bias = dsv4_parameter(torch.zeros(dim))
