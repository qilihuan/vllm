...
from vllm.models.deepseek_v4.amd.model_engine.scheduler import ScheduledBatch
from vllm.models.deepseek_v4.amd.model_ops.attentions.backends import (
    AttentionBackend,
...
class DeepseekV4AttentionMetadataBuilder(CommonAttentionBuilder):
    ...
    def __init__(self, model_runner):
        ...
        # Validated via `DSV4_ROCM_DEBUG_FORCE_SKIP_DRAFT_MODEL=1` (100% reject =
    ...
    def allocate_per_req_cache(self, num_slots: int) -> dict[str, object]:
        ...
        if is_pd:
            pool_size = int(os.environ.get("DSV4_ROCM_PD_STAGING_POOL", "32"))
    ...
    def build_kv_cache_tensor(self, layer_id: int, module):
        ...
        from vllm.models.deepseek_v4.amd.models.deepseek_v4 import Compressor as _V4Compressor
        from vllm.models.deepseek_v4.amd.models.deepseek_v4 import DeepseekV4Attention as _V4Attention
        from vllm.models.deepseek_v4.amd.models.deepseek_v4 import Indexer as _V4Indexer
    ...
    def get_kv_transfer_tensors(self):
        from vllm.models.deepseek_v4.amd.kv_transfer.disaggregation.types import (
            KVTransferRegion,
            KVTransferTensors,
        )
    ...
    def build_ubatch_prefill_metadata(
        ...
        from vllm.models.deepseek_v4.amd.utils.tbo.ubatch_splitting import split_attn_metadata
