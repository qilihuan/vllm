...
from __future__ import annotations  # [vLLM-DSV4-ATOM-port] defer ScheduledBatch annot
...
if TYPE_CHECKING:
    from vllm.models.deepseek_v4.amd.kv_transfer.disaggregation.types import KVTransferTensors
    # [vLLM-DSV4-ATOM-port] ScheduledBatch is the ATOM-native engine batch type;
    # used here only as a type annotation. The native engine (model_engine) is
    # not vendored for the vLLM DSv4 path, so import it for typing only.
...
from vllm.models.deepseek_v4.amd.utils.tbo.ubatch_splitting import UBatchSlice, split_attn_metadata
from vllm.models.deepseek_v4.amd.utils.forward_context import AttentionMetaData, AttnState
