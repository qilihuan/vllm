...
from vllm.models.deepseek_v4.amd.model_ops.attention_mla import MLAAttention, MLAModules
from vllm.models.deepseek_v4.amd.model_ops.linear import use_triton_gemm
from vllm.models.deepseek_v4.amd.plugin.vllm.attention.backend import (
    AiterMlaBackendForVllm,
    AiterSparseMlaBackendForVllm,
    build_vllm_mla_prefill_backend,
)
from vllm.models.deepseek_v4.amd.plugin.vllm.attention.layer_common import (
...
class AttentionForVllmMLA(MLAAttention, AttentionLayerBase):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        cache_config = dsv4_config.plugin_config.vllm_cache_config
        quant_config = dsv4_config.plugin_config.vllm_quant_config
        scheduler_config = dsv4_config.plugin_config.vllm_scheduler_config
        ...
        self.kv_cache_torch_dtype = kv_cache_dtype_str_to_dtype(
            cache_dtype, dsv4_config.plugin_config.vllm_config.model_config
        )
        ...
        if getattr(self, "is_sparse_mla", False):
            ...
            self.q_pad_num_heads = kwargs.get("q_pad_num_heads", None)
            from vllm.models.deepseek_v4.amd.model_ops.attention_mla import _MLA_MIN_HEADS
        ...
        dsv4_static_context = dsv4_config.compilation_config.static_forward_context
        dsv4_static_context[model_layer_name] = self
        if "positions" not in dsv4_static_context:
            max_num_tokens = scheduler_config.max_num_batched_tokens
            dsv4_static_context["positions"] = torch.zeros(
    ...
    def forward_impl(
        ...
        if positions is None:
            dsv4_config = get_current_dsv4_config()
            positions = dsv4_config.compilation_config.static_forward_context[
                "positions"
            ]
    ...
    def forward(
        ...
        **kwargs,
        ...
        output = torch.ops.aiter.dsv4_vllm_mla_attention(
            q,
            kv_c_normed,
            k_pe,
            self.layer_name,
