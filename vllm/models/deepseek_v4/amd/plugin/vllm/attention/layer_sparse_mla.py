...
from vllm.models.deepseek_v4.amd.plugin.prepare import is_vllm
...
def IndexerDecoratorForPluginMode(cls):
    if getattr(cls, "_dsv4_vllm_indexer_decorated", False):
        return cls
    ...
    cls._dsv4_vllm_indexer_decorated = True
    return cls
...
def DeepseekV32IndexerCacheDecoratorForPluginMode(cls):
    if getattr(cls, "_dsv4_vllm_indexer_cache_decorated", False):
        return cls
    ...
    cls._dsv4_vllm_indexer_cache_decorated = True
    return cls
