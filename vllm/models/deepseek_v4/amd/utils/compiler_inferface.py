...
from vllm.models.deepseek_v4.amd.utils import compilation_counter, is_torch_equal_or_newer
...
def _patch_triton_cluster_dims_for_rocm() -> None:
    ...
    try:
        ...
        return
    if getattr(_tcc.CompiledKernel, "_dsv4_cluster_dims_patched", False):
        return
    ...
    _tcc.CompiledKernel._dsv4_cluster_dims_patched = True
