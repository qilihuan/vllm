...
from vllm.models.deepseek_v4.amd.config import CompilationConfig, Config, CUDAGraphMode
from vllm.models.deepseek_v4.amd.utils import (
    compilation_counter,
...
def get_static_graph_wrapper_cls(cls) -> str:
    return "vllm.models.deepseek_v4.amd.utils.cuda_graph.CUDAGraphWrapper"
...
class VllmBackend:
    ...
    def __call__(self, graph: fx.GraphModule, example_inputs) -> Callable:
        ...
        from vllm.models.deepseek_v4.amd.utils.decorators import torch_compile_start_time
