...
from vllm.models.deepseek_v4.amd.config import CompilationConfig, Config, CompilationLevel

from vllm.models.deepseek_v4.amd.utils.graph_marker import graph_marker

# from vllm.models.deepseek_v4.amd.utils import start_monitoring_torch_compile
...
def _decorate_record_function(func: Callable, prefix: Optional[str] = None):
    ...
    def _wrapped(*args, **kwargs):
        ...
        from vllm.models.deepseek_v4.amd.utils.graph_marker import is_graph_marker_enabled
...
def _support_torch_compile(
    ...
    def __init__(self, dsv4_config: Config, **kwargs):
        old_init(self, dsv4_config=dsv4_config, **kwargs)
        self.dsv4_config = dsv4_config
        # for CompilationLevel.DYNAMO_AS_IS , the upper level model runner
        # will handle the compilation, so we don't need to do anything here.
        self.do_not_compile = dsv4_config.compilation_config.level in [
        ...
        TorchCompileWrapperWithCustomDispatcher.__init__(
            self,
            vllm_config=dsv4_config,
            compilation_level=dsv4_config.compilation_config.level,
        )
    ...
    def __call__(self, *args, **kwargs):
        ...
        if len(self.compiled_codes) < 1:
            ...
            start_monitoring_torch_compile(self.dsv4_config)
