...
`atom/model_ops/v4_kernels/doc/DSV4_ROCM_V4_PAGED_PREFILL_DESIGN.zh.md` §1, §3
...
def sparse_attn_v4_paged_prefill_reference(
    ...
    from vllm.models.deepseek_v4.amd.model_ops.sparse_attn_v4 import _sparse_attn_ragged_torch
