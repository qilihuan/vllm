...
from vllm.models.deepseek_v4.amd.model_ops.layernorm import RMSNorm
from vllm.models.deepseek_v4.amd.model_ops.linear import ReplicatedLinear
...
class DeepseekV4MTPModel(nn.Module):
    ...
    def __init__(self, dsv4_config: Config, args: DeepseekV4Args) -> None:
        super().__init__()
...
class DeepseekV4MTP(nn.Module):
    ...
    def __init__(self, config: Config, prefix: str = "") -> None:
        ...
        self.model = DeepseekV4MTPModel(dsv4_config=config, args=self.args)
