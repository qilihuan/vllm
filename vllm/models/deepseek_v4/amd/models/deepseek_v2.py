...
from vllm.models.deepseek_v4.amd.config import Config, QuantizationConfig, get_current_dsv4_config
from vllm.models.deepseek_v4.amd.model_ops.activation import SiluAndMul
from vllm.models.deepseek_v4.amd.model_ops.attention_mla import (
    MLAModules,
...
from vllm.models.deepseek_v4.amd.model_ops.base_attention import Attention
from vllm.models.deepseek_v4.amd.model_ops.embed_head import ParallelLMHead, VocabParallelEmbedding
from vllm.models.deepseek_v4.amd.model_ops.layernorm import LayerNorm, RMSNorm
...
from vllm.models.deepseek_v4.amd.model_ops.topK import is_rocm_aiter_fusion_shared_expert_enabled
from vllm.models.deepseek_v4.amd.model_ops.utils import MXFP4_QUANT_BLOCK_SIZE, dsv4_parameter
from vllm.models.deepseek_v4.amd.models.utils import (
    IntermediateTensors,
    PPMissingLayer,
...
from vllm.models.deepseek_v4.amd.utils.decorators import mark_trace, support_torch_compile
from vllm.models.deepseek_v4.amd.utils.forward_context import get_forward_context
from vllm.models.deepseek_v4.amd.plugin.vllm.attention.layer_sparse_mla import (
...
ENABLE_DS_QKNORM_FUSION = True
ENABLE_ALLREDUCE_RMSNORM_FUSION = True
ENABLE_DS_INPUT_RMSNORM_QUANT_FUSION = True
    ...
    def __init__(
        ...
        if config.n_shared_experts is not None:
            if not self.is_rocm_aiter_fusion_shared_expert_enabled:
                tbo_active = get_current_dsv4_config().enable_tbo
                if 1024 > 0 and not tbo_active:
                    self._use_dual_stream = True
                    compilation_config = get_current_dsv4_config().compilation_config
...
def sparse_attn_indexer(
    ...
    runner_block_size = get_current_dsv4_config().kv_cache_block_size
...
class IndexerWkWeightsProjLinear(MergedReplicatedLinear):
    ...
    def __init__(
        ...
        self.weight_scale = dsv4_parameter(
            torch.empty(
...
class Indexer(nn.Module):
    def __init__(
        ...
        self.max_model_len = dsv4_config.max_model_len
        self.prefix = prefix
        self.max_total_seq_len = dsv4_config.max_num_seqs * self.max_model_len
        ...
        dsv4_config.compilation_config.static_forward_context[prefix] = self
...
class DeepseekV2DecoderLayer(nn.Module):
    def __init__(
        ...
        # Because AR_RMS and RMS_Quant cannot co-exist for input_layernorm, this block of codes ensures 3 things when DSV4_ROCM_ENABLE_DS_INPUT_RMSNORM_QUANT_FUSION is turned on:
        ...
        if quant_config is not None and ENABLE_DS_INPUT_RMSNORM_QUANT_FUSION:
            ...
            if enable_fp8_input_norm_quant or enable_fp4_input_norm_quant:
                ...
                if self.fuse_ar_input_norm:
                    ...
                    if layer_idx == 0:
                        logger.info(
                            "Warning: Because DSV4_ROCM_ENABLE_DS_INPUT_RMSNORM_QUANT_FUSION is turned on, AR + RMS fusion is turned off for input_layernorm and reduce_results is re-enabled for first k dense layer down_proj"
                        )
...
class DeepseekV2Model(nn.Module):
    def __init__(
        ...
        config = dsv4_config.hf_config
        cache_config = dsv4_config.kv_cache_dtype
        quant_config = dsv4_config.quant_config
        self.config = config
